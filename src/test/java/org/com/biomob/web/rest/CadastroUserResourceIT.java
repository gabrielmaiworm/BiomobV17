...
class CadastroUserResourceIT {
    ...
    void createCadastroUser() throws Exception {
        ...
        assertThat(testCadastroUser.getDocumentoNumero()).isEqualTo(DEFAULT_DOCUMENTO_NUMERO);
    ...
    void putNewCadastroUser() throws Exception {
        ...
        assertThat(testCadastroUser.getDocumentoNumero()).isEqualTo(UPDATED_DOCUMENTO_NUMERO);
