...
class CadastroDoacaoResourceIT {
    ...
    private static final LocalDate DEFAULT_DATA_DOACAO = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATA_DOACAO = LocalDate.now(ZoneId.systemDefault());
