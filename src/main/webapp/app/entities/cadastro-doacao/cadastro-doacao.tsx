                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {cadastroDoacao.dataDoacao ? (
                      <TextFormat type="date" value={cadastroDoacao.dataDoacao} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  ...
                  <td>{cadastroDoacao.nome ? <Link to={`cadastro-user/${cadastroDoacao.nome.id}`}>{cadastroDoacao.nome.id}</Link> : ''}</td>
                  <td>
                    {cadastroDoacao.descricao ? (
                      <Link to={`doacao-item/${cadastroDoacao.descricao.id}`}>{cadastroDoacao.descricao.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
