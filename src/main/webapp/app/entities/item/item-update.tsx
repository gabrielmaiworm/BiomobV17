  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="bioMobApp.item.home.createOrEditLabel" data-cy="ItemCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Saldo" id="item-saldo" name="saldo" data-cy="saldo" type="text" />
