...
class AcaoResourceIT {
    ...
    void createAcao() throws Exception {
        ...
        assertThat(testAcao.getDataCriacao()).isEqualTo(DEFAULT_DATA_CRIACAO);
        ...
        assertThat(testAcao.getFoto()).isEqualTo(DEFAULT_FOTO);
        assertThat(testAcao.getFotoContentType()).isEqualTo(DEFAULT_FOTO_CONTENT_TYPE);
    ...
    void putNewAcao() throws Exception {
        ...
        Acao testAcao = acaoList.get(acaoList.size() - 1);
        assertThat(testAcao.getDataCriacao()).isEqualTo(UPDATED_DATA_CRIACAO);
        ...
        assertThat(testAcao.getFoto()).isEqualTo(UPDATED_FOTO);
        assertThat(testAcao.getFotoContentType()).isEqualTo(UPDATED_FOTO_CONTENT_TYPE);
