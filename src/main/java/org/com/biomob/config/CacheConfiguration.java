...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.com.biomob.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.com.biomob.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, org.com.biomob.domain.DoacaoItem.class.getName());
            createCache(cm, org.com.biomob.domain.Item.class.getName());
            createCache(cm, org.com.biomob.domain.SolicitacaoItem.class.getName());
            createCache(cm, org.com.biomob.domain.CadastroDoacao.class.getName());
            createCache(cm, org.com.biomob.domain.CadastroSolicitacao.class.getName());
