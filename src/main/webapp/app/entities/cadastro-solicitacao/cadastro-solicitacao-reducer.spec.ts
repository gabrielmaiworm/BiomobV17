...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './cadastro-solicitacao.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CADASTROSOLICITACAO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CADASTROSOLICITACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CADASTROSOLICITACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CADASTROSOLICITACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CADASTROSOLICITACAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CADASTROSOLICITACAO actions', async () => {
      const expectedActions = [
        {
