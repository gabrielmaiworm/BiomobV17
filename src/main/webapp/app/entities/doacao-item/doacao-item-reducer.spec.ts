...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOACAOITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOACAOITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOACAOITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOACAOITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOACAOITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOACAOITEM actions', async () => {
      const expectedActions = [
        {
