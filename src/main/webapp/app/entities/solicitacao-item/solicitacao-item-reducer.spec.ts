...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOLICITACAOITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOLICITACAOITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOLICITACAOITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOLICITACAOITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOLICITACAOITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOLICITACAOITEM actions', async () => {
      const expectedActions = [
        {
