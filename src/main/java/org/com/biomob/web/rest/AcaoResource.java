...
public class AcaoResource {
    ...
    public ResponseEntity<Acao> partialUpdateAcao(@PathVariable(value = "id", required = false) final Long id, @RequestBody Acao acao)
        ...
        Optional<Acao> result = acaoRepository
            .findById(acao.getId())
            .map(existingAcao -> {
                if (acao.getDataCriacao() != null) {
                    existingAcao.setDataCriacao(acao.getDataCriacao());
                }
                ...
                if (acao.getFoto() != null) {
                    existingAcao.setFoto(acao.getFoto());
                }
                if (acao.getFotoContentType() != null) {
                    existingAcao.setFotoContentType(acao.getFotoContentType());
                }
